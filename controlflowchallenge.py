...
# We need to make sure that the result of our spending is less than the total amount we have allocated for 
# each of the categories. Our function will accept a parameter called budget which describes our spending limit. 
...
# Define the function to accept five parameters starting with budget then 
...
def twice_as_large(num1, num2):
    if num1 > 2 * num2:
        ...
        return False
print(twice_as_large)

# To make things a bit more challenging, we are going to create a function that determines whether or not a 
# number is divisible by ten. A number is divisible by ten if the remainder of the number divided by 10 is 0. 
...
# Our function will accept two inputs and add them together. 
