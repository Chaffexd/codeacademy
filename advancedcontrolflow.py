...
# Our function will split the ratings into different ranges and 
# tell the user how the movie was based on the movie’s rating. Here are the steps needed:
...
# For the final challenge, we are going to select which number from three input values is 
# the greatest using conditional statements. To do this, we need to check the different combinations of 
# values to see which number is greater than the other two. Here is what we need to do:
